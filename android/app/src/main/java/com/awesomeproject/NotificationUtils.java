...
public class NotificationUtils {
     ...
     */
    private static final int BEACON_REMINDER_NOTIFICATION_ID = 1138;
    /**
     * This pending intent id is used to uniquely reference the pending intent
     */
    private static final int BEACON_REMINDER_PENDING_INTENT_ID = 3417;
    /**
     * This notification channel id is used to link notifications to this channel
     */
    private static final String BEACON_REMINDER_NOTIFICATION_CHANNEL_ID = "reminder_notification_channel";
    ...
    public static void notifyBeaconHasBeenFound(Context context, String contentText) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel mChannel = new NotificationChannel(
                    BEACON_REMINDER_NOTIFICATION_CHANNEL_ID,
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,BEACON_REMINDER_NOTIFICATION_CHANNEL_ID)
                .setColor(ContextCompat.getColor(context, R.color.colorPrimary))
                .setSmallIcon(R.drawable.ic_drink_notification)
                .setLargeIcon(largeIcon(context))
                .setContentTitle(context.getString(R.string.beacon_reminder_notification_title))
                .setContentText(contentText)
                .setStyle(new NotificationCompat.BigTextStyle().bigText(contentText))
                .setDefaults(Notification.DEFAULT_VIBRATE)
                .setContentIntent(contentIntent(context, contentText))
                .setAutoCancel(true);
        ...
        notificationManager.notify(BEACON_REMINDER_NOTIFICATION_ID, notificationBuilder.build());
    }
    ...
    private static PendingIntent contentIntent(Context context, String contentText) {
        // COMPLETED (2) Create an intent that opens up the MainActivity
        Intent startActivityIntent = new Intent(context, MainActivity.class);
        startActivityIntent.putExtra("data", contentText);
        ...
        return PendingIntent.getActivity(
                context,
                BEACON_REMINDER_PENDING_INTENT_ID,
                startActivityIntent,
